...
document.getElementById("today").innerHTML = "Đây là bài làm của Đinh Hoàn Hảo, thực hiện ngày " + dateTime;
...
function success(){
  ...
  let message = document.getElementById("contentinput").value;
  if(name == ""){
